					...
					<li class="active open">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="home_all.php">
									<i class="menu-icon fa fa-caret-right"></i>
									ตารางการลงทะเบียนทั้งหมด
								</a>

								<b class="arrow"></b>
							</li>
							<li class="">
								<a href="home_all.php?page=nos">
									<i class="menu-icon fa fa-caret-right"></i>
									ปกติ ชำระเงินแล้ว
								</a>
							...
							<form id="myform1" name="myform1" method="post" action="" novalidate>
								<button type="submit" name="btn_sen_notify" id="btn_sen_notify" value="1" class="btn btn-info btn-round btn-lg btn-block">ส่งรายงาน</button>
							</form>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select class="form-control" name="news" id="news" >
                                                <option value="ปกติ">สมัครประเภทธรรมดา  10  กิโลเมตร  (10 K Race) ค่าสมัคร 400 บาท </option>
                                                <option value="VIP">สมัครประเภท VIP 10  กิโลเมตร  (10 K Race) ค่าสมัคร 1000 บาท </option>
                                            </select>
                                            </div>
                                        </div>
                                    </div>
